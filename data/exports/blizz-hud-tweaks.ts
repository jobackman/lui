...
export const blizzHudTweaks: AddonCategory = {
  ...
  export: {
    name: 'BlizzHUDTweaks',
    description: 'Sets up fading of UI elements based on player state (in combat, out of combat, <99% health, etc).',
    ...
    lastUpdated: "2026-02-05T21:11:29.924Z",
    downloadUrl: 'https://www.curseforge.com/wow/addons/blizzhudtweaks',
    images: [
      "https://i.imgur.com/HKE6iXR.mp4",
    ],
...
3. Pick a profile name, paste the profile string, and click import`,
    tags: [tag.ui, tag.hud, tag.combat],
  },
