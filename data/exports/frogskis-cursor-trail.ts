...
export const frogskisCursorTrail: Addon = {
  ...
  export: {
    ...
    media: [
      { type: 'image', url: 'https://media.forgecdn.net/attachments/1495/40/logo2.png' },
      { type: 'image', url: 'https://media.forgecdn.net/attachments/1495/6/options2.png' },
    ],
