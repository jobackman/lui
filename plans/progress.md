...
- Changed background ripple to absolute positioning w/ fixed large height and full viewport width. Uses width: 100vw to span beyond container, 3x viewport height (min 3000px). Scrolls naturally w/ page, gradients align properly across full width. Build+tests pass.
