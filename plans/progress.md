...
- Changed background ripple to absolute positioning w/ fixed large height. Uses 3x viewport height (min 3000px) to create scrollable grid that spans beyond content. Scrolls naturally w/ page, no harsh gradient cut-offs. Wrapped App in relative div. Build+tests pass.
