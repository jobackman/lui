...
- URL state mgmt: Added nuqs. Migrated expandedCardId to useQueryState('expanded'). Full-width expanded cards via conditional col-span logic (!isExpanded check). Deep linking works. Browser back/forward nav collapses cards. Build+tests pass.
